    ...
    <div class="container">
        ...
        <section id="beranda" class="container-fluid">
            ...
            <div class="col-12 text-center">
                <h1 class="kondisi"><b>Selamat Datang di Kedai Cinta</b></h1>
        ...
        <!-- menus -->
        <div id='fullMenu' class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('menus.destroy', $menu->id) }}" method="POST">
                                            <a href="{{ route('menus.show', $menu->id) }}" class="btn btn-sm btn-dark">SHOW</a>
